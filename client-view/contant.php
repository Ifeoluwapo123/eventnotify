  ...
  <section id="mu-menu">
    <div class="container-fluid">
      ...
      <div class="col-sm-9 blog">
        <div class="container-fluid">
          <div class="row content">
            <h2 style="text-align: center; margin-top: 30px;">Get in touch</h2>
            <p  style="text-align: center;">contact us by sending messages to our email</p>
            <p  style="text-align: center; margin-bottom: 30px;">all requests will be attended to.</p>
            <table style="margin-bottom: 30px;">
            <form action="contant.php" method="POST">
              <tr><input type="text" name="email" placeholder="Enter Email"></tr><br>
              <tr><input type="text" name="subject" placeholder="Enter Subject"></tr><br>
              <tr><textarea name="message" cols="46" rows="5" placeholder="Enter your measage"></textarea></tr><br>
              <button type="submit" name="submitMail">Send message </button>
            </form>
            </table>
          </div>
        </div>
