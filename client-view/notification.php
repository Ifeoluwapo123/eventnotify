  ...
  <section id="mu-menu">
    <div class="container-fluid">
      ...
      <div class="col-sm-9 blog">
        <div class="container-fluid">
          <div class="row content" style="margin-top: 10px; text-align: center; margin-bottom: 20px;">
          <?php
            $query = "SELECT image_caption, image_filename, image_date
                  FROM images";
            $result = mysqli_query($con, $query) or die(mysqli_error($con));
            while($row = mysqli_fetch_array($result)){
              extract($row);
            ?>
              <img src="../pictures/<?php echo $image_filename;?>" class='thumbnail'>
              <p><?php echo $image_caption."<br/> Uploaded on: ".$image_date ?> </p>
              <hr>
          <?php
           }
          ?>
