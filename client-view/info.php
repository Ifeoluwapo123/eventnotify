      ...
      <div class="col-sm-9 blog">
        <div class="container-fluid">
          <div class="row content">
	        ...
	        <hr>
          <?php
            $query = 'CREATE TABLE IF NOT EXISTS info(image_id  INTEGER  NOT NULL AUTO_INCREMENT, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, PRIMARY KEY (image_id)) ENGINE=MyISAM';
            mysqli_query($con, $query) or die (mysqli_error($con));
            ?>
            <form action="info.php" method="POST" style="">
	            <input type="email" name="email" placeholder="Type your Email">
	             <input type="text" name="phone-number" placeholder="Type your Mobile Number" style="margin-bottom: 8px;">
            ...
            if(isset($_POST['submit'])){
            	...
            	$query = 'INSERT INTO info(username, email, phone) VALUES("'.$_SESSION['name'].'","'.$email.'","'.$phone.'")'; 
                $result = mysqli_query($con, $query) or die (mysqli_error($con));
                if($result == true){
                	echo "<p> You have successfully Subscribed to this platform<p>";
                	echo "You will start getting updates via your mobile number and email";
                }
            }
            ?>
            <br>
