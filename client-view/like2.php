          ...
          <div class="row content">
           ...
           <hr>
            <?php
              ...
              foreach ($rows as $row) {
                echo "<h4><strong style='font-family:sans-serrif; font-size: 25px;'>Event Title/Description:</strong> ".$row['image_caption']."</h4>";
                 echo "<p><strong style='color:red'>Posted on:</strong>"." ".$row['image_date']."</p>";
                  ?>
                <a href="pictures/<?php echo $d;?>"><img src='../pictures/<?php echo $d;?>' class='thumbnail' 
                style='float:left; margin-bottom: 15px; border: 1px solid #ddd'></a>
                <p style= "clear: left;"><?php echo $row['image_textfile'] ?></p>
                <hr>
              <div id="com">
              <?php     
              ...
              <li><a href=<?php echo "comment.php?imageid=".$d?>>Comment<?php echo " "."<b style=''>".$number."</b>"?></a></li>
              ...
              <?php
              $query = "SELECT user_id FROM rating_info WHERE post_id = '".$row['image_id']."'";
              $result = mysqli_query($con, $query) or die(mysqli_error($con));
              echo "<hr>";
              echo "<h4><strong>People that liked the post</strong></h4>";
