  ...
  <section id="mu-menu">
    <div class="container-fluid">
      ...
      <div class="col-sm-9 blog">
        ...
        <hr>
        <h4 style="float: right; margin-bottom:30px">You are Welcome: <strong><?php echo $_SESSION['name'];?></strong></h4>
        <h4><a href='notify.php' style="color:red; border-radius: 10px; margin-bottom: 10px; padding: 10px; background-color: #f8f8f8;"><strong>My-Profile</strong></a></h4>
        <hr>
        <?php 
          ...
          ?>
            <h5><span class="glyphicon glyphicon-time"></span><strong style='color:red'>Post by Campus Notifier </strong><?php echo $row['image_date'];?></h5>  
            <a href="pictures/<?php echo $row['image_filename'];?>"><img src='../pictures/<?php echo $row['image_filename'];?>' class='thumbnail'></a>
            <h5><span class="label label-danger">Event</span> <span class="label label-primary">News</span></h5><br>
        <?php
          $count = "SELECT image_filename FROM comments WHERE image_filename ='".$row['image_filename']."'";
          $query = mysqli_query($con, $count) or die(mysqli_error($con));  
          $number = mysqli_num_rows($query);
          echo '<p>'.$row["image_textfile"].'</p>';
          ?>
          <hr>
          <div class="com">
            <li><a href=<?php echo "comment.php?imageid=".$row['image_filename']?>>Comment<?php echo "<b style=''> ".$number."</b>";?></a></li> 
            <li class='li'><a href=<?php echo "like2.php?imageid=".$row['image_filename']?>>Like
            </a><em
            <?php if(userLiked($row['image_id'])){?>
