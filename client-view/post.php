          ...
          <div class="row content">
            ...
            <hr>
		      ...
		      while($row = mysqli_fetch_assoc($result)){
		        echo ($odd == true)? "<tr style='background-color: #EEE'>" : "<tr style='background-color: #FFFFFF'>";
		        $odd = !$odd;
		        echo "<td style='width:10%;'>".$row['image_id']."</td>";
		        echo "<td style='width:60%;'>".$row['image_caption']."</td>";
		        echo "<td style='width:30%;'>".$row['image_date']."</td>";
		        echo "<td style='width:10%;'>";
		        echo '<a href="post1.php?imageid='.$row['image_id'].'" >[DELETE]</a>';
		        echo "</td>"; 
		        echo "</tr>";
		      }
		        echo "</table>";
